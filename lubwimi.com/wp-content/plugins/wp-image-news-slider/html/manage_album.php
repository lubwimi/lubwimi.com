...
?>
<?php if(isset($gimn->messages['upload']) && is_array($gimn->messages['upload']) && count($gimn->messages['upload']) > 0): ?>
<div class="updated">
<p class="">
<?php foreach($gimn->messages['upload'] as $msg): ?>
	<span><?php print $msg; ?></span><br/>
<?php endforeach;?>
</p>
</div>
<?php endif; ?>
<script type="text/javascript">var slider_current_album_id = <?php print $album['album_id']; ?>;</script>
<div class="dataTable_wrapper">
	<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
		...
		<?php slider_get_table_actions(array('slider_bulk_delete_images' => 'Delete', 
											'slider_bulk_disable_images' => 'Disable', 
											'slider_bulk_enable_images' => 'Enable')); ?>
	</div>
	...
	<tbody>
	<?php require_once IMN_PLUGIN_DIR . '/html/images_rows.php'; ?>
	</tbody>
	</table>
...
<div id="single_upload" class="tab_content">
	<form id="single_upload_form" action="" method="post" enctype="multipart/form-data">
		<input type="hidden" name="task" value="slider_single_image_upload" />
...
-->
	...
	var slider_upload_dir = "<?php  /* add the replace "\\" to work on windows server */  print str_replace("\\","/",slider_get_album_dir($album['album_id'])); ?>";
	</script>
</div><!-- end id="single_upload" -->
